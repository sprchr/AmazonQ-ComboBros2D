...
pygame.display.set_caption("Super Smash Bros Retro 2D - Character Select")
...
CHARACTERS = {
    ...
    'link': {
        ...
        'attack_power': 12,
        'special_power': 30,
        'description': 'Strong attacks but slower movement'
    },
    'kirby': {
        'name': 'Kirby',
        ...
        'attack_power': 8,
        'special_power': 20,
        'description': 'Fast and high jumps, but weaker attacks'
    }
}
